...
ALTER TABLE orders
  ...
  ADD COLUMN IF NOT EXISTS "orderSource" VARCHAR(50) DEFAULT 'web',
  ADD COLUMN IF NOT EXISTS cashier_name VARCHAR(100),
  ADD COLUMN IF NOT EXISTS "cashierName" VARCHAR(100),
  ADD COLUMN IF NOT EXISTS cashier_id VARCHAR(100),
  ADD COLUMN IF NOT EXISTS "cashierId" VARCHAR(100),
