                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {selectedOrderForTracking.paymentStatus === 'Paid' ? (
                          ...
                          <button
                            onClick={() => {
                              customAlert('Payment confirmation is pending. Official Payment Receipt will be unlocked once payment is marked as Paid. You can view and download your Tax Invoice now.');
                          ...
                          <div className="flex flex-wrap items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-800 gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {order.paymentStatus === 'Paid' ? (
                                ...
                                <button
                                  onClick={() => {
                                    customAlert('Payment confirmation is pending. Official Payment Receipt will be unlocked once payment is marked as Paid. You can print your Tax Invoice now.');
