...
export function formatToGMT3(dateInput: string | Date | undefined | null): string {
  ...
  try {
    ...
    raw = raw.replace(/\s*(EAT|GMT\+3|\+03:00)$/i, '').trim();
    ...
    if (dateInput instanceof Date) {
      ...
      // String like "2026-08-28 12:04:11" stored without timezone designator -> parse as UTC
...
export interface VisitorAnalyticsSummary {
  ...
  liveOnlineNow?: number;
  liveCustomersOnline?: number;
  liveVisitors15m: number;
  activeOnlineVisitors?: LiveActiveVisitor[];
